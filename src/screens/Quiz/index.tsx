...
export function Quiz() {
  ...
  const fixedPropgressBarStyle = useAnimatedStyle(() => {
    return{
      position:'absolute',
      zIndex:1,
      paddingTop:50,
      ...
      width: '110%',
      left: '-5%',
      opacity:interpolate(scrollY,[50,90],[0,1],Extrapolate.CLAMP),
      transform:[
        {translateY:interpolate(scrollY, [50,100], [-40,0], Extrapolate.CLAMP)}
      ]
    }
  })
  ...
  const headerStyles = useAnimatedStyle(() => {
    return{
      opacity: interpolate(scrollY, [60,90], [1,0], Extrapolate.CLAMP)
    }
  })
